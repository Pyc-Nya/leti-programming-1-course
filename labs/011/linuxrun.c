...
int main() {
    glob_t glob_result;
    const char *pattern = "sharpinskiy*.c";
    ...
    snprintf(compile_command, sizeof(compile_command), "gcc %s -std=c90 -o main.exe", file_to_compile);
    ...
    int run_result = system("./main.exe");
